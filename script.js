...
const mobileMenuBg =
    document.querySelector('.mobile-menu-bg');
...
const prevButton =
    document.querySelector('.visual-prev');

const nextButton =
    document.querySelector('.visual-next');

const currentSlide =
    document.querySelector('.current-slide');

const progress =
    document.querySelector('.indicator-progress');
